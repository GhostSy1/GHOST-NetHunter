...
VERSION = "3.0-PRO"
PROFILE = "Network asset inventory and service discovery auditor"
RULES = [('NET-ASSET', 'host|address|MAC|vendor|operating system'), ('NET-SERVICE', 'port|service|banner|protocol'), ('NET-SCOPE', 'authorized|allowlist|scope|inventory')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-NetHunter v3.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
